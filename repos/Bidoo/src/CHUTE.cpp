...
struct CHUTEWidget : ModuleWidget {
	CHUTEWidget(CHUTE *module) : ModuleWidget(module) {
		...
		addParam(ParamWidget::create<BidooBlueKnob>(Vec(portX[1], portY[0]-2.0f), module, CHUTE::ALTITUDE_PARAM, 0.01f, 3.0f, 1.0f));
		addInput(Port::create<PJ301MPort>(Vec(portX[0], portY[1]),Port::INPUT, module, CHUTE::GRAVITY_INPUT));
		addParam(ParamWidget::create<BidooBlueKnob>(Vec(portX[1], portY[1]-2.0f), module, CHUTE::GRAVITY_PARAM, 1.622f, 11.15f, 9.798f)); // between the Moon and Neptune
		addInput(Port::create<PJ301MPort>(Vec(portX[0], portY[2]),Port::INPUT, module, CHUTE::COR_INPUT));
		addParam(ParamWidget::create<BidooBlueKnob>(Vec(portX[1], portY[2]-2.0f), module, CHUTE::COR_PARAM, 0.0f, 1.0f, 0.69f)); // 0 inelastic, 1 perfect elastic, 0.69 glass
