...
void Micromacro::step()
{
    ...
    params[CLOCK_SOURCE].value == 0.0 ? clock_source_ext = false : clock_source_ext = true;
    ...
    params[PLAY].value == 1.0 ? paused = false : paused = true;
...
MicromacroWidget::MicromacroWidget(Micromacro *module) : ModuleWidget(module)
{
    ...
    addParam(ParamWidget::create<CKSS>(Vec(635, 61.5), module, Micromacro::CLOCK_SOURCE, 0.0, 1.0, 0.0));
    ...
    addParam(ParamWidget::create<SonusLedButton>(Vec(728, 86.5), module, Micromacro::PLAY, 0.0, 1.0, 1.0));
...
Model *modelMicromacro = Model::create<Micromacro, MicromacroWidget>("Sonus Modular", "Micromacro", "Pitch Quantized Sequencer", SEQUENCER_TAG);
